...
assert.equal(tip.callbacks.title([{dataIndex:0}]),'09.12');
assert.equal(tip.callbacks.title([{dataIndex:1}]),'09.13');
...
assert.equal(tip.callbacks.title([{dataIndex:1}]),'10.01');
f.win.chartData=[{timestamp:'2026-01-03T00:00:00+09:00',count:31},{timestamp:'2026-02-30',count:0}];
assert.equal(tip.callbacks.title([{dataIndex:0}]),'01.03');
assert.equal(tip.callbacks.title([{dataIndex:1}]),'');
